...
const Hero = () => {
  return (
    <div className='w-full flex flex-col-reverse md:flex-row justify-between items-center gap-2 px-4 md:px-24 py-24 text-center md:text-left'>
      <div className='flex flex-col gap-8 w-full lg:w-10/12'>
        <div className='w-full md:w-auto'>
          ...
          <h1 className='lg:text-5xl text-3xl font-bold leading-relaxed text-dark dark:text-white'>
            Frontend Developer
          </h1>
      ...
      <div className='w-full py-4 lg:py-0 lg:w-7/12'>
